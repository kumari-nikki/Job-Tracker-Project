        ...
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-200'>
            ...
            <div>
                ...
                <p className='text-sm text-gray-600'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum optio natus reiciendis amet ipsa fugit vero expedita? Nesciunt, quo possimus!
                </p>
            </div>
            ...
            <div className="flex items-center gap-4 mt-4">
                <Button onClick={() => navigate(`/description/${jobId}`)} variant="outline" className="border-gray-200">
                    Details
                </Button>
                <Button
                    className="bg-[#7209b7] text-white border border-gray-200 hover:bg-[#7209b7] focus:bg-[#7209b7]"
                >
                    Save For Later
                </Button>
            </div>
