        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8'>
                <div className='flex justify-between'>
                    ...
                    <Button className="text-right border border-gray-200" variant="outline"><Pen /></Button>
                </div>
                <div className='flex items-center gap-3 mt-4'>
                    <Mail size={18} />
                    <span>nikkii@gmail.com</span>
                </div>
                <div className='flex items-center gap-3 mt-2'>
                    <Contact size={18} />
                    <span>9798997423</span>
                </div>
                <div className='my-5'>
                    <h1>Skills</h1>
                ...
                <div className='grid w-full max-w-sm items-center gap-1.5'>
                    ...
                    {
                        isResume
                            ? <a target="_blank" href="https://localhost:7909/" className='text-blue-500 w-full hover:underline cursor:pointer'>View Resume</a>
                            : <span>NA</span>
                    }
                </div>
            </div>
